...
<?php
    ...
    echo "<a href='./Questions/q1.php'>Question 1 : Change the PHP configuration so that it can take 8Mb of RAM per use, timeout at 60s, allow 50Mb of uploads and be in the 'Europe/Paris' timezone. Check the configuration in CLI and in a webserver using phpinfo()</a>";
    ...
    */
    ...
    echo "<a href='./Questions/q2.php'>Question 2 : PHP basics again, using PHP integrated server, create PHP scripts (with comments😏), called via HTTP (not via CLI), that:</a>";
